 ...
 * `vendor:publish --tag=beam-ux-migrations` copies this flat file into the host's `database/migrations/`
 * (central pass) and its `tenant/` twin into `database/migrations/tenant/` (Stancl tenant pass), and the
