 ...
 * `vendor:publish` copies the flat central file into the host's `database/migrations/` and this `tenant/`
 * twin into `database/migrations/tenant/`, and the HOST runs each pass, so the columns exist identically
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasColumn('beam_ux_entries', 'format')) {
            return;
        }
