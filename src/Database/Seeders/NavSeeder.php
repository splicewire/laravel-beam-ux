 ...
 * content-nav seeding can join the package-registered {@see \Splicewire\Beam\Seed\BeamSeedManifest} — which
 ...
 * `updateOrCreate`); this wrapper only invokes it so `splicewire:beam:seed` restamps the per-realm sitemaps'
